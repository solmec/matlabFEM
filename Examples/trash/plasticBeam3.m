...
nelem = size(elems,1);
 ...
 supports  = [ nearestTo( nodes, [ 0, 0 ], [ 1 1 ] ) ...
                                              nearestTo( nodes, [ dx, 0 ], [ 0 1 ] ) ...
                                              nearestTo( nodes, [ 2*dx, 0 ], [ 0 1 ] )...
                                              nearestTo( nodes, [ 3*dx, 0 ], [ 0 1 ] )...
                                              nearestTo( nodes, [ 4*dx, 0 ], [ 0 1 ] )...
                                              nearestTo( nodes, [ 5*dx, 0 ], [ 0 1 ] )...
                                              nearestTo( nodes, [ 6*dx, 0 ], [ 0 1 ] )...
                                              nearestTo( nodes, [ 7*dx, 0 ], [ 0 1 ] )...
                                              nearestTo( nodes, [ 8*dx, 0 ], [ 0 1 ] )...
                                              nearestTo( nodes, [ 9*dx, 0 ], [ 0 1 ] )...
