...
P( 1 + 2 * closestNode( nodes, [ lx / 2    0 ] ) ) = P0; % [N]
P( 1 + 2 * closestNode( nodes, [ lx / 2 + dx   0 ] ) ) = P0; % [N]
P( 1 + 2 * closestNode( nodes, [ lx / 2 + 2*dx 0 ] ) ) = P0; % [N]
P( 1 + 2 * closestNode( nodes, [ lx / 2 - dx   0 ] ) ) = P0; % [N]
P( 1 + 2 * closestNode( nodes, [ lx / 2 - 2*dx 0 ] ) ) = P0; % [N]
...
plasticTopologyOptimization( 'plasticBeam2', nodes, elems, elemClassL4, P, material, profile, supports, x, lx, ly, nx, ny );
