...
Py =  P0 * sin( al0 / 180.0 * pi );
Px = -P0 * cos( al0 / 180.0 * pi );
...
P( 2 * closestNode( nodes, [ lx    ly/2 ] ) -1 ) = -P0; % [N]
P( 2 * closestNode( nodes, [ lx    ly/2 ] )    ) = 0.0; % [N]
mP = [mP P];
...
cenv = multiLoadMultiTopologtOptanalysis( 'plasticshortCantileverJanos', nodes, elems, elemClassL4, mP, material, profile, supports, x, lx, ly, nx, ny );
