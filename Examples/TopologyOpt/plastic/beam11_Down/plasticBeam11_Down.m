...
P( 2 * closestNode( nodes, [ lx / 2 + 2*dx 0 ] ) ) = P0; % [N]
P( 2 * closestNode( nodes, [ lx / 2 - dx   0 ] ) ) = P0; % [N]
P( 2 * closestNode( nodes, [ lx / 2 - 2*dx 0 ] ) ) = P0; % [N]
...
cenv = threeLoadMultiTopologtOptanalysis( 'plasticBeam11_Down', nodes, elems, elemClassL4, mP, material, profile, supports, x, lx, ly, nx, ny );
