function [ disp, GPdatas, corr ] = incrementalPlaneStressPlasticAnalysisD( elemClass, nodes, elems, Fext, mat, pr, supports, x )
...
% updating strains, stress and other variables;  
        for i=1:nelem
                ...
                GPdatas(i) = updateStressStrainD( GPdatas(i), de, mat, x(i) );
        end
